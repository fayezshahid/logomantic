    ...
    <body>
                ...
                <div class="d-table-cell">
                    <div class="container">
                        <div class="page-banner-content">
                            <h2>Create a Company Letterhead Using Our Templates</h2>
                            <ul>
                                <li>
        ...
        <section class="about-area ptb-100">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="about-image-warp letter-head-bg ">
                    ...
                    <div class="col-lg-6">
                        <div class="about-content warp">
                            <span>Letter Head Design</span>
                            <h3>Create A Company Letterhead Using Our Templates</h3>
                            <div class="bar"></div>
                            <strong>With our DIY letterhead maker, you can make professional letterhead designs in minutes, and get it printed too!.</p>

                            <div class="about-inner-content">
                                <div class="icon">
                                    <i class="flaticon-check"></i>
                                </div>
                                <h4>Lots of Creative Templates</h4>
                                <p>Tens of templates to choose from.
                        ...
                        <div class="single-portfolio-item">
                            <div class="portfolio-image">
                                <a href="portfolio-details.html">
                                    <img src="assets/new-image/letter-head/image-1.jpg" alt="image">
                                </a>
                            </div>

                            <div class="portfolio-content">
                                <h3>
                                    <a href="portfolio-details.html">Letter Head</a>
                                </h3>

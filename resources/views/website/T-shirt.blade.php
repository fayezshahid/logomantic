    ...
    <body>
        ...
        <section class="about-area ptb-100">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="about-image-warp image-three Tshirt-bg ">
                    ...
                    <div class="col-lg-6">
                        <div class="about-content warp">
                            ...
                            <h3>Fabulous T-Shirt Design </h3>
                            <div class="bar"></div>
                            <strong>Get a custom design with a t-shirt maker and print it too in the best quality and style. Whether you are looking for premium quality t-shirts for giveaways, special events or just to establish your brand through your employees wearing company t-shirt designs, we have just the right one for you.:</p>

                            <div class="about-inner-content">
                                <div class="icon">
                                    <i class="flaticon-check"></i>
                                </div>
                                <h4>Custom T-Shirt Design</h4>
                                <p>Cotton blend t-shirts pre-shrunk
                                    7 Sizes to choose, from XS to 3XL
                                    7 Color variations
                                    Multiple styles and designs
                                    T-shirts for men, women, children
                                    Premium quality t-shirt option too</p>
                            </div>
                        ...
                        <div class="single-portfolio-item">
                            <div class="portfolio-image">
                                <a href="portfolio-details.html">
                                    <img src="assets/new-image/T-shirt/image-1.jpg" alt="image">
                                </a>
                            </div>

                            <div class="portfolio-content">
                                <h3>
                                    <a href="portfolio-details.html">T-Shirt </a>
                                </h3>

                        ...
                        <div class="col-lg-9 col-md-12 margin">
                            <div class="order-details">
                                ...
                                <div class="payment-box borderr">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="select-box">
                                                            <select class="form-control" style="display: none;" name="logoType">
                                                                <option disabled selected>Select a logo Type</option>
                                                                @foreach ($industries as $industry)
                                                                    <option value="{{ $industry->name }}" @if($industry->name == $logoType) selected @endif>{{ $industry->name }}</option>
                                                                @endforeach
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input value="{{ $bName }}" type="text" name="bName" id="bName" class="form-control">
                                                    </div>
                                                </div>
                                    ...
                                    <button type="submit" class="default-btn col-lg-6 margin">
                                        Search Now
                                    </button>
                                </div>
                            </div>
                            ...
                            {{-- <div class="col-lg-4 col-md-6">
                                <div class="single-products-box">
                                    ...
                                    <div class="products-content center">
                                        ...
                                        <a href="cart.html" class="add-to-cart">Category</a>
                                    </div>
                                    ...
                                    <div class="single-products-box">
                                        ...
                                        <div class="features-btn" style="text-align: center">
                                            ...
                                            <form action="{{ route('customizeLogo') }}" method="POST" id="form{{ $logo->id }}">
                                                ...
                                                <input type="hidden" name="fontColor" id="fontColor{{ $logo->id }}">
                                                <input type="hidden" name="fontFamily" id="fontFamily{{ $logo->id }}">
                                                <a type="button" class="default-btn new-btn" onclick="submitForm('form{{ $logo->id }}')">Want To Customize Free?</a>
                                            </form>
                                        </div>
                                    </div>
                                </div>
        ...
        <script>
            ...
            function setIds(ids){
                for(var i=0; i<ids.length; i++){
                    var sourceImage = document.getElementById("logoImage" + ids[i].id);
                ...
                $('.txt').css('left', x/2 + 'px');
                $('.txt').css('right', x/2 + 'px');
            }

            function submitForm(id){
                var x = id.charAt(id.length - 1);
                $('#fontColor' + x).val($('#txt' + x).css('color'));
                $('#fontFamily' + x).val($('#txt' + x).css('font-family'));
                $('#' + id).submit();
            }

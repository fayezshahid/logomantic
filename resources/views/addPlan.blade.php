...
<style>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-8" style="margin-top: 30px;">
            <form action="{{ route('addPlan') }}" method="post" id="form">
                @csrf
                <div class="mb-4">
                    <label class="form-label" style="font-weight: normal">Plan Name</label>
                    <input type="text" name="name" placeholder="Enter plan name" class="form-control @error('name') border-3 border-danger @enderror" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="price" placeholder="Enter plan price" class="form-control @error('price') border-3 border-danger @enderror" value="{{ old('price') }}">
                    @error('price')
                        <div class="text-danger">
                            {{ $message }}
                        </div>

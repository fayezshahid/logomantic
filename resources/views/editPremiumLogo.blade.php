...
<style>
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-8" style="margin-top: 30px;">
            <form id="form" action="{{ route('editPremiumLogo', $logo->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="mb-4">
                ...
                <div>
                    <button type="button" id="btn" class="btn btn-primary btn-block mb-4">Update Premium Logo</button>
                </div>
            </form>
        </div>
    </div>  
